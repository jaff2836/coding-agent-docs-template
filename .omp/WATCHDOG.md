...
- `docs/PLAN.md` §8에 `Accepted`로 기록된 결정을 근거 없이 되돌리는 변경. 결정의 전제가 깨졌다는 증거가 있으면 그 증거를 함께 적어 주세요.
...
- `docs/DESIGN.md` §1 적용 조건에 해당하는 변경을 설계 절차 없이 바로 구현하기 시작하는 경우.

## 보고하지 않을 것

- `docs/REVIEW.md` §8 Do Not Report에 해당하는 항목
- §9 Accepted Deferrals와 `docs/PLAN.md` §12에 기록된 보류 항목을 되돌리라는 요구
