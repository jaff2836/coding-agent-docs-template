...
- 2026-09-22: synchronized Origin·GitHub `main`과 annotated tag가 가리키는 `v2.3.1` exact source `3460e4ccd0065bcd8a24fd64a6cd7135293926a0`에서 candidate와 immutable published `--base-version 2.3.0` 검증이 통과했습니다. 검증된 5개 asset은 게시 전후 교체하지 않았습니다.
