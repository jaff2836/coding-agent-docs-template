...
| --- | --- | --- | --- |
| 1 | `codex/t017-windows-junction-design` | T-017: native Windows에서 junction을 재현·설계 | **In Progress** — Buildkite `windows-ci` build #16에서 Windows gate 176개와 native junction 재현 통과, Origin 성공 check 확인; 전체 설계 합의·자동 trigger 확인은 미완료 |
